...
in
{
  options.local.theme = {
    ...
    colors = {
      ...
      tertiary = colorOption selected.tertiary "Tertiary accent color";
      ...
      tertiaryForeground = colorOption selected.tertiaryForeground "Text on tertiary accent";
